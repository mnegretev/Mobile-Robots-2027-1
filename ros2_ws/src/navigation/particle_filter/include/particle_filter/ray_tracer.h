#ifndef PARTICLE_FILTER_RAY_TRACER_H
#define PARTICLE_FILTER_RAY_TRACER_H

#include <particle_filter/impl/ray_trace_iterator.h>
#include "sensor_msgs/msg/laser_scan.hpp"
#include "nav_msgs/msg/occupancy_grid.hpp"
#include "geometry_msgs/msg/pose.hpp"
#include "particle_filter/coordinate_conversions.h"
#include <cmath>
...
namespace ray_tracer
{
    ...
    inline double euclideanDistance (const geometry_msgs::msg::Point& p1, const geometry_msgs::msg::Point& p2)
    {
    ...
    RayTraceIterRange rayTrace (const nav_msgs::msg::MapMetaData& info, const geometry_msgs::msg::Point& p1, 
				const geometry_msgs::msg::Point& p2, bool project_target_onto_grid=false,
