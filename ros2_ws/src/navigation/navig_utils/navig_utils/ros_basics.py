...
FULL_NAME = "Juan Diego Bello Jose"
...
class RosBasicsNode(Node):
    ...
    def callback_scan(self, msg):
        ...
        #
        n = len(msg.ranges)
        self.obstacle_left = msg.ranges[n//2 + 100] < 2.0
        self.obstacle_right = msg.ranges[n//2 - 100] < 2.0
        self.obstacle_front = msg.ranges[n//2] < 2.0
