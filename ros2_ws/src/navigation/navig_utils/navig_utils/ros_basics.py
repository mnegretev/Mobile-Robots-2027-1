...
FULL_NAME = "Romero Soto Raymundo"
...
class RosBasicsNode(Node):
    ...
    def callback_scan(self, msg):
        ...
        #
        n = len(msg.ranges)
        self.obstacle_left = msg.ranges[n//2 + 60] < 1.5
        self.obstacle_right = msg.ranges[n//2 - 60] < 1.5
        self.obstacle_front = msg.ranges[n//2] < 1.5        
        return
